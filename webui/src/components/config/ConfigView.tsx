      ...
      <div className="p-6">
        ...
        {needsRestart && (
          <div className="mb-4 bg-yellow-50 border border-yellow-200 rounded p-3">
            <p className="text-xs text-yellow-800">
              <strong>⚠️ Server restart required:</strong> Configuration changes have been saved but won't take effect until you restart the Mockingbird server.
            </p>
          </div>
        )}
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-xs font-medium text-gray-600 uppercase tracking-wider">Backend Keys</h2>
            <Button
              variant="primary"
              size="sm"
                ...
                <div key={key} className="p-3">
                  {editing === key ? (
                    <div className="flex items-center gap-2">
                      ...
                      <Button variant="primary" size="sm" onClick={() => saveEdit(key)}>
                        Save
                      </Button>
        ...
        <div className="bg-gray-50 border border-gray-200 rounded p-3">
          <p className="text-xs text-gray-600">
            ...
            <code className="bg-gray-100 px-1 rounded">config.json</code> and injected into requests via templates. Changes made here are saved immediately, but you must restart the Mockingbird server for them to take effect.
          </p>
        </div>
      </div>
    </div>
